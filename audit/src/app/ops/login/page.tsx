...
import { setOpsSession } from "@/lib/ops-api";
...
export default function OpsLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setOpsSession(data.token, data.user);
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse at 30% 20%, rgba(168,85,247,0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(6,182,212,0.06) 0%, transparent 50%), #060a14",
      }}
    >
      <div className="relative w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-sm tracking-widest uppercase mt-2" style={{ color: "#64748b" }}>
            Manual Review · Policy Overrides
          </p>
        </div>
